                            ...
                            <el-tooltip class="item" effect="dark" content="选择或新增购买用户" placement="top">
                                <div class="inner_content" :class="{ 'cover':cover[0].firstForm }">
                                    <div class="inner_content_customerInfo">
                                        <el-form :model="firstForm_Data" ref="firstForm_Data"
                                                 label-width="210px" style="margin-left: -70px">
                                            <el-form-item label="客户名称">
                                                <el-input v-model="firstForm_Data.phone_number"
                                            ...
                                            <el-form-item label="客户地址">
                                                <el-input v-model="firstForm_Data.address"
                                    ...
                                    <div class="inner_content_tip">
                                        <el-alert title="小提示:" type="success" :closable="false"
                                                  description="点击此区域任意位置可进入选择用户界面~~">
                                        </el-alert>
                                    </div>
                                </div>
                            </el-tooltip>
                        ...
                        <div class="commodity_info" @click.capture="changeView($event,'secondForm',1)">
                            ...
                            <el-tooltip class="item" effect="dark" content="新增商品条目" placement="bottom">
                                <div class="inner_content" :class="{ 'cover':cover[1].secondForm }">
                                    ...
                                    <div class="inner_content_tip">
                                        <el-alert title="小提示:" type="info" :closable="false"
                                                  description="点击此区域任意位置可进入添加商品界面~~">
                                        </el-alert>
                                    </div>
                                </div>
                            </el-tooltip>
        ...
        .list_content {
            ...
            .footer_info {
                ...
                .inner_content {
                    ...
                    .inner_content_customerInfo, .inner_content_commodityInfo {
                        flex: 3;
