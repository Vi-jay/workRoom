<template>
    <div id="thirdForm">
        ...
        <el-button type="warning" id="back_btn" @click="backhome('thirdForm')"><i class="el-icon-d-arrow-left"></i><span
                style="margin-left:10px">返回</span></el-button>
        <div class="seller">
            <el-form :model="sellerForm" ref="thirdForm" class="sellerForm" style="margin-left: 10px">
                ...
                <el-form-item>
                    <el-alert class="tip" title="小提示:" type="success" :closable="false"
