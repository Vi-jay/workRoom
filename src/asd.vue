    ...
    export default {
        data(){
            return {
                ...
                flag: true,
                today: this.thisDay,
                lastTwoMonthDay: this.twoMonthAgo,
                lastMonthDay: this.oneMonthAgo,
                destroyTimer:{}
            }
        },
        methods: {
            ...
            getData(){
                this.$http.post(this.basePath + '/saleModeReport/getSaleModeReportInfo', {
                        begin_report_time: this.getCurrentMonthFirst(),
                        end_report_time: this.getCurrentMonthLast()
                    }
                ).then((res) => {
                    let resData = this.initOrderTypeData(res.body.rows);
                ...
                this.$http.post(this.basePath + '/saleReport/getSaleReportInfoByAirBottleTypeInfo', {
                    begin_report_time: this.today,
                    end_report_time: this.today
                })
                    .then((res) => {
                        let resData = this.initOrderData(res.body.rows);
                ...
                this.$http.post(this.basePath + '/returnBottleRateReport/getStoreReturnBottleDetailReportInfo', {
                    begin_report_time: this.lastTwoMonthDay,
                    end_report_time: this.today
                }).then((res) => {
                    let resData = this.initAvgReturnBottleRateData(res.body.rows, this.lastTwoMonthDay, this.lastMonthDay, this.today);
                ...
                this.$http.get(this.basePath + '/store/getStoreInventoryInfo').then((res) => {
                    let resData = this.initStoreInventoryData(res.body.data.rows);
